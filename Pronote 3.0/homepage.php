                ...
                if($tipo == "adm"){
                    ...
                    if($escolas){
                        for($c = 0; $c < count($escolas); $c++){
                            ...
                            <a href='#'><img style='width: 100px; height: 100px;' src='./Img´s/desenho.png'></a>
                            <a href='#'><button id='escola$c' onmouseenter='ativo($c)' onmouseout='inativo($c)' style='cursor:pointer; padding: 15px; border: none; box-shadow: 2px 2px 1px rgb(0, 0, 0, 0.453); outline: none; color: teal; background-color: azure;'>".$escolas[$c]["nome_escola"]."</button></a>
                            </div>";
                        }
                    }
                }
